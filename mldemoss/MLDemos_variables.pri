...
QT += svg opengl core gui widgets
...
CONFIG(Release){
    message(Release libraries added!)
    LIBS +=   -lQt5Svg -lQt5OpenGL -lQt5Gui -lQt5Core -lQt5Widgets
  }else{
    message(Debug libraries added!)
    LIBS += -lQt5Svgd -lQt5OpenGLd -lQt5Cored  -lQt5Guid -lQt5Widgetsd
}
...
win32{
    CONFIG(boost):BOOST = C:\boost\boost_1_55_0
#    CONFIG(opencv21)|CONFIG(opencv22):OPENCV = C:/DEV/OpenCV2.3-GCC
    CONFIG(opencv21)|CONFIG(opencv22):OPENCV =  C:\\OpenCV\\install
}else:macx{
